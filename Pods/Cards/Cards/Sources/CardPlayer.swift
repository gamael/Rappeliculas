...
@IBDesignable open class CardPlayer: Card {
    ...
    open override func initialize() {
        ...
        backgroundIV.addSubview(player.view)
    ...
    open override func layout(animating: Bool = true) {
...
extension CardPlayer: PlayerDelegate {
    ...
    public func playerPlaybackStateDidChange(_: Player) {}
    public func playerBufferingStateDidChange(_: Player) {}
    public func playerBufferTimeDidChange(_: Double) {}
}
...
extension CardPlayer: PlayerPlaybackDelegate {
    ...
    public func playerPlaybackWillLoop(_: Player) {}
    public func playerCurrentTimeDidChange(_: Player) {}
    public func playerPlaybackWillStartFromBeginning(_: Player) {}
}
