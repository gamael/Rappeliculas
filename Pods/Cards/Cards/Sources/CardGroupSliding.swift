...
@IBDesignable open class CardGroupSliding: CardGroup {
    ...
    open override func layout(animating: Bool) {
    ...
    public func startSlide() {
        timer = Timer.scheduledTimer(timeInterval: 0.04, target: self, selector: #selector(slide), userInfo: nil, repeats: true)
    }
